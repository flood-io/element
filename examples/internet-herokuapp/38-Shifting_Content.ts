...
export default () => {
	...
	step('Test: 02 - Shifting Content', async (browser) => {
		...
		const pageTextVerify = By.visibleText('Shifting Content')
		await browser.wait(Until.elementIsVisible(pageTextVerify))
	})

	step('Test: 03 - Shifting Content: Image', async (browser) => {
		const linkHref = await browser.findElement(By.css('#content > div > a:nth-child(6)'))
		await linkHref.click()
		await browser.wait(Until.elementIsVisible(By.css('#content > div > img')))
		const pageTextVerify = By.visibleText('Shifting Content: Image')
		await browser.wait(Until.elementIsVisible(pageTextVerify))
	})

	step('Test: 04 - Randomly', async (browser) => {
		const linkHref = await browser.findElement(By.css('#content > div > p:nth-child(3) > a'))
		await linkHref.click()
		await browser.wait(Until.elementIsVisible(By.css('#content > div > img')))
		const pageTextVerify = By.visibleText('Shifting Content: Image')
		await browser.wait(Until.elementIsVisible(pageTextVerify))
	...
	step('Test: 05 - 100px Shifting', async (browser) => {
		const linkHref = await browser.findElement(By.css('#content > div > p:nth-child(4) > a'))
		await linkHref.click()
		await browser.wait(Until.elementIsVisible(By.css('#content > div > img')))
		const pageTextVerify = By.visibleText('Shifting Content: Image')
		await browser.wait(Until.elementIsVisible(pageTextVerify))
	...
	step('Test: 06 - 100px Shifting + Randomly', async (browser) => {
		const linkHref = await browser.findElement(By.css('#content > div > p:nth-child(5) > a'))
		await linkHref.click()
		await browser.wait(Until.elementIsVisible(By.css('#content > div > img')))
		const pageTextVerify = By.visibleText('Shifting Content: Image')
		await browser.wait(Until.elementIsVisible(pageTextVerify))
	...
	step('Test: 07 - 100px Shifting + Randomly', async (browser) => {
		const linkHref = await browser.findElement(By.css('#content > div > p:nth-child(6) > a'))
		await linkHref.click()
		await browser.wait(Until.elementIsVisible(By.css('#content > div > img')))
		const pageTextVerify = By.visibleText('Shifting Content: Image')
		await browser.wait(Until.elementIsVisible(pageTextVerify))
