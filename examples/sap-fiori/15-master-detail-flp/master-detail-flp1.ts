...
export default () => {
  ...
  step('Master Detail FLP Demo App: Home', async browser => {
    await browser.visit('https://sapui5.hana.ondemand.com/test-resources/sap/ui/demoapps/demokit/master-detail/webapp/test/flpSandboxMockServer.html#MasterDetail-display')
