...
export default () => {
  ...
  step('SAP viz chart demo: Home', async browser => {
    await browser.visit('https://sapui5.hana.ondemand.com/test-resources/sap/viz/demokit/chartdemo/index.html')
  ...
  step('SAP viz chart demo: Chart Popover', async browser => {
    ...
    let obj_datapoint = By.css('#UIComp_1 > svg > g.v-m-main > g.v-m-plot > g:nth-child(4) > g > g.v-datapoint-group > g:nth-child(2) > g:nth-child(2)')
