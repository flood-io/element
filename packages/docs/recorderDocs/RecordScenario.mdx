...
* **Action-specific value fields**
  ...
  * You can use [variables][variables] to make up a value. Just type a double curly brackets `{{` anywhere in the field and select a variable from the suggestion list.
...
For `NAVIGATE` action, you can directly edit the URL in the Recording screen.
