...
This setting is no longer supported since version 2.0. Instead, you can use [browser](#browser) setting or *executablePath* property in [browserLaunchOptions](#browserlaunchoptions) setting.
